...
const create_wallets_dto_1 = require("../dto/create-wallets.dto");
const update_wallets_dto_1 = require("../dto/update-wallets.dto");
...
let WalletsController = class WalletsController {
    ...
    create(createWalletDto, profileId) {
    ...
    update(id, updateWalletDto, profileId) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_wallets_dto_1.CreateWalletDto, Number]),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], WalletsController.prototype, "getBalanceById", null);
__decorate([
    (0, common_1.Get)(':id'),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(1, (0, get_user_decorator_1.GetUser)('profileId')),
...
__decorate([
    ...
    __param(2, (0, get_user_decorator_1.GetUser)('profileId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, update_wallets_dto_1.UpdateWalletDto, Number]),
    __metadata("design:returntype", void 0)
