...
let UsersService = class UsersService {
    ...
    categoriesService;
    walletsService;
    constructor(usersRepository, categoriesService, walletsService) {
    ...
    async create(createUserDto) {
        try {
            ...
            throw new common_1.BadRequestException('The user couldnt be created');
        }
    }
    async update(id, updateUserDto) {
        try {
            ...
            throw new common_1.BadRequestException('The user couldnt be updated');
        }
    }
    async remove(id) {
        const user = await this.findOne(id);
